...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="#">
            <img src="img/logo_aeroport.JPG" alt="logo imag"> Our-Airport
        </a>
...
<!-- partie JQuery pour les associations entre les deux select  -->
    ...
    <!-- Partie login permet au client de se connecter à on compte  -->
    <!-- Si jamais le client ne possede pas un compte il peut creer son propre compte  -->
                  ...
                  <?php  ?>
                    <form class="login-box" action="php/login.php" method="post">
                        <div class="row">
                            ...
                            <button type="submit" name="signin" class="btn btn-outline-primary" >SIGN IN</button>
                    </form>

                    <p>Already have an account <a href="php/register.php">SIGN UP</a></p>
